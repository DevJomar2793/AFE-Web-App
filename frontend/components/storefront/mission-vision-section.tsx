    ...
    <section id="promise" className="section-shell scroll-mt-24 bg-[#f9f7f0]">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2">
          <FadeIn>
            <article className="h-full border border-[#dcd7ca] bg-white p-7 sm:p-9">
              ...
              <p className="mt-5 text-base leading-8 text-[#60685f] sm:text-lg">
                Our mission is to provide high-quality eggs at affordable
                prices through convenient, reliable service. By delivering
                fresh eggs directly from our farm to your doorstep, we make
                farm-fresh quality easier to bring to your table.
              </p>
            </article>
          </FadeIn>

          <FadeIn delay={100}>
            <article className="h-full bg-[#173b24] p-7 text-white sm:p-9">
              <div className="flex items-center justify-between gap-4">
              ...
              <p className="eyebrow mt-8 text-[#f5bd78]">
                Where we are going
              </p>
